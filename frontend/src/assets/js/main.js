...
var errorMobMap = ["Invalid number", "Invalid country code", "Too short", "Too long", "Invalid number"];
...
mobile.addEventListener('blur', function() {
    ...
    if (mobile.value.trim()) {
        if (mobile_intTel.isValidNumber()) {
            ...
            errorMobMsg.innerHTML = '<i class="fa-solid fa-square-xmark"></i> '+errorMobMap[errorCode];
...
$(document).ready(function(){
    otpBtn.click(function(event){
        ...
        let full_mobile = mobile_intTel.getNumber(intlTelInputUtils.numberFormat.E164);
